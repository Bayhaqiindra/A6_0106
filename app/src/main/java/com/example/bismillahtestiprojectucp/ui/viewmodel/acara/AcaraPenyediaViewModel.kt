...
object AcaraPenyediaViewModel {
    val Factory = viewModelFactory {
        ...
        initializer { DetailAcaraViewModel(createSavedStateHandle(), acr = acaraApp().container.acaraRepository) }
        initializer { UpdateAcaraViewModel(createSavedStateHandle(), acr = acaraApp().container.acaraRepository) }
    }
}
